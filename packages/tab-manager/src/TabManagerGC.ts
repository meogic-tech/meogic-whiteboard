...
import type {TabManagerState} from './TabManagerState';
import type {NodeKey, NodeMap} from './TabManagerNode';

import {$isElementNode} from '.';
import {cloneDecorators} from './TabManagerUtils';
...
export function $garbageCollectDetachedDecorators(
    ...
    const nodeMap = pendingTabManagerState._nodeMap;
    let key;
...
export function $garbageCollectDetachedNodes(
    ...
    const prevNodeMap = prevTabManagerState._nodeMap;
