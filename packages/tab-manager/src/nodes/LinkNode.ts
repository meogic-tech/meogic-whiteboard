...
export class LinkNode extends ElementNode {
  ...
  $setNewPosition() {
    const sourceNode = $getNodeByKey(this.getLatest()._sourceKey) as ShapeNode
    const targetNode = $getNodeByKey(this.getLatest()._targetKey) as ShapeNode
  ...
  updateDOM(prevNode: LinkNode, dom: HTMLElement, config: TabManagerConfig): boolean {
    return false
  }

  updateDOMProperties(prevNode: LinkNode, dom: HTMLElement, config: TabManagerConfig) {
