...
export class BackgroundNode extends ElementNode {
  ...
  updateDOM(prevNode: BackgroundNode, dom: HTMLElement, config: TabManagerConfig): boolean {
    return false
  }

  updateDOMProperties(prevNode: BackgroundNode, dom: HTMLElement, config: TabManagerConfig) {
