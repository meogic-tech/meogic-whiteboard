...
import type {WhiteboardState} from './WhiteboardState';
import type {NodeKey, NodeMap} from './WhiteboardNode';

import {$isElementNode} from '.';
import {cloneDecorators} from './WhiteboardUtils';
...
export function $garbageCollectDetachedDecorators(
    ...
    const nodeMap = pendingWhiteboardState._nodeMap;
    let key;
...
export function $garbageCollectDetachedNodes(
    ...
    const prevNodeMap = prevWhiteboardState._nodeMap;
